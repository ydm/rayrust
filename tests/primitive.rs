...
fn sphere_intersection() {
    let sphere = primitive::Sphere::new(
        &na::Point3::new(0.0, 0.0, -5.0), // center
        1.0                               // radius
    );
    ...
    // Two intersections
    let ray2 = ray::Ray::<f32>::new(&na::Point3::new(0.0, 0.0, 5.0), &d);
    ...
    // One intersection
    let ray1 = ray::Ray::<f32>::new(&na::Point3::new(1.0, 0.0, 5.0), &d);
    ...
    // Zero intersections
    let ray0 = ray::Ray::<f32>::new(&na::Point3::new(1.1, 0.0, 5.0), &d);
