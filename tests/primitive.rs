...
fn sphere_intersection() {
    let sphere = primitive::Sphere::new(&lin::p(0.0, 0.0, -5.0), 1.0);
    let d = lin::v(0.0, 0.0, -1.0);

    // Two intersections
    let ray2 = ray::Ray::<f32>::new(&lin::p(0.0, 0.0, 5.0), &d);
    ...
    // One intersection
    let ray1 = ray::Ray::<f32>::new(&lin::p(1.0, 0.0, 5.0), &d);
    ...
    // Zero intersections
    let ray0 = ray::Ray::<f32>::new(&lin::p(1.1, 0.0, 5.0), &d);
